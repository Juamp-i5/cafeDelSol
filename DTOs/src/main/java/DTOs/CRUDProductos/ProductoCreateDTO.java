...
public class ProductoCreateDTO {
    ...
    public ProductoCreateDTO(String nombre, String descipcion, CategoriaProducto categoria, byte[] imagenData, EstadoProducto estadoProducto, Map<TamanioProducto, Double> precios, Map<IngredienteViejoListDTO, Map<TamanioProducto, Double>> ingredientes) {
        this.nombre = nombre;
